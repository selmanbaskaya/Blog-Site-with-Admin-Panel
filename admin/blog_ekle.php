...
<head>
    ...
    <title>Blog Ekle| Admin Yönetim Paneli</title>
...
<?php
    if (@$_POST["submit"]) {
        ...
        $ekle = $db->prepare("INSERT INTO `blog` (`baslik`, `at_baslik`, `aciklama`, `aktif`) VALUES 
                            (:baslik, :at_baslik, :aciklama, :aktif) ");
        $ekle->bindValue(":baslik", $baslik, PDO::PARAM_STR);
        $ekle->bindValue(":at_baslik", $alt_baslik, PDO::PARAM_STR);
                            ...
                            <div class="col-lg-6">
                                <form role="form" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="mytextarea" name="aciklama" rows="3" placeholder="Açıklama Giriniz"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Durum</label>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="aktif" id="" value="1" checked>
                                                Aktif
                                            </label>
                                        </div>
                                        <div class="radio">
